...
const StudentCard = ({ student,onOpenModal }) => {
  ...
  return (
    <div className="flex items-center justify-between bg-[#FFFFFF33] border border-[#FFFFFF33] rounded-[14px] px-4 py-3 shadow-sm cursor-pointer" onClick={() => onOpenModal(student)}>
