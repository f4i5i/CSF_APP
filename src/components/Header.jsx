  ...
  return (
    <header className="w-full py-1 flex justify-between max-sm:items-center max-sm:px-3">
      <div className="w-full mr-6 ml-1 mt-5 max-sm:mx-auto flex items-center justify-between max-sm:justify-between">
        ...
        {/* RIGHT: PROFILE */}
        <div className="max-md:hidden flex items-center justify-between gap-3 cursor-pointer">
      ...
      <div className="hidden max-md:flex items-center gap-2 cursor-pointer max-sm:justify-end max-sm:items-end pr-2">
        <img
          onClick={() => setOpen(!open)}
          ref={dropdownRef}
          src={logo}
