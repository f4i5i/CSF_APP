...
export const API_ENDPOINTS = {
  ...
  CHILDREN: {
    ...
    EMERGENCY_CONTACT_BY_ID: (contactId) =>
      `/children/emergency-contacts/${contactId}`,
  },
  ...
  CLASSES: {
    ...
    PRACTICES: (id) => `/classes/${id}/practices`, // Get generated practice dates
    CANCEL_PRACTICE: (id) => `/classes/${id}/practices/cancel`, // Cancel/restore a practice date
  },
  ...
  ENROLLMENTS: {
    ...
    REVIEW: (id) => `/enrollments/${id}/review`, // Review panel aggregate (ADMIN)
    PAYMENT_REMINDER: (id) => `/enrollments/${id}/payment-reminder`, // Re-email open invoice link (OWNER)
  ...
  DISCOUNTS: {
    ...
    SIBLING_ELIGIBILITY: (childId) =>
      `/discounts/sibling-eligibility/${childId}`, // Check sibling discount eligibility
    ...
    SYNC_STRIPE: (id) => `/discounts/codes/${id}/sync-stripe`,
  ...
  ADMIN: {
    ...
    CANCELLATION_REQUEST_APPROVE: (id) =>
      `/cancellation-requests/${id}/approve`, // Approve
