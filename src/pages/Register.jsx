            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full font-manrope px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base rounded-md border ${errors.address ? "border-red-500" : "border-gray-300"} outline-none focus:ring-2 focus:ring-primary`}
                />
                {errors.address && (
              ...
              <div>
                ...
                <input
                  ...
                  value={formData.city}
                  onChange={handleChange}
                  className={`w-full font-manrope px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base rounded-md border ${errors.city ? "border-red-500" : "border-gray-300"} outline-none focus:ring-2 focus:ring-primary`}
                />
                {errors.city && (
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full font-manrope px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base rounded-md border ${errors.state ? "border-red-500" : "border-gray-300"} outline-none focus:ring-2 focus:ring-primary`}
                />
                {errors.state && (
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full font-manrope px-3 sm:px-4 py-2 sm:py-2.5 text-sm sm:text-base rounded-md border ${errors.zip_code ? "border-red-500" : "border-gray-300"} outline-none focus:ring-2 focus:ring-primary`}
                />
                {errors.zip_code && (
