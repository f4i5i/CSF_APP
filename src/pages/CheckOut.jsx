      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Card saving is always on for parent checkouts — memberships
                and waitlist auto-enrollment bill the stored card. */}
            {hasChildSelected &&
              waiversChecked &&
              !isFreeClass &&
              paymentMethod === "full" && (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <span className="font-manrope">
                      <span className="block text-sm font-semibold text-[#173151]">
                        Your card is saved securely for future payments
                      </span>
                      <span className="block text-xs text-[#666D80] mt-1">
                        Monthly memberships, future registrations, and waitlist
                        auto-enrollment are billed to this card. It is stored
                        securely by Stripe — we never see or store your full
                        card details. You can update it anytime from Payment
                        Methods.
                      </span>
                    </span>
                  </div>
