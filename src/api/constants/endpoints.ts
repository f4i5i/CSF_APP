...
export const ENDPOINTS = {
  ...
  CHILDREN: {
    ...
    EMERGENCY_CONTACTS: (childId: string) =>
  ...
  ENROLLMENTS: {
    ...
    CANCELLATION_PREVIEW: (id: string) =>
      `/enrollments/${id}/cancellation-preview`,
    // Waitlist
    WAITLIST_JOIN: "/enrollments/waitlist/join",
    WAITLIST_CLAIM: (id: string) => `/enrollments/${id}/waitlist/claim`,
    WAITLIST_CLASS: (classId: string) =>
      `/enrollments/waitlist/class/${classId}`,
  ...
  SUBSCRIPTIONS: {
    ...
    CANCELLATION_PREVIEW: (id: string) =>
      `/subscriptions/${id}/cancellation-preview`,
  ...
  ATTENDANCE: {
    ...
    STREAK: (enrollmentId: string) =>
      `/attendance/enrollment/${enrollmentId}/streak`,
    BULK_CREATE: "/attendance/bulk",
    SUMMARY: "/attendance/summary/",
    ENROLLMENT_HISTORY: (enrollmentId: string) =>
      `/attendance/enrollment/${enrollmentId}/history`,
    ENROLLMENT_STATS: (enrollmentId: string) =>
      `/attendance/enrollment/${enrollmentId}/stats`,
    ENROLLMENT_STREAK: (enrollmentId: string) =>
      `/attendance/enrollment/${enrollmentId}/streak`,
  ...
  BADGES: {
    ...
    PROGRESS: (enrollmentId: string) =>
      `/badges/enrollment/${enrollmentId}/progress`,
  },
